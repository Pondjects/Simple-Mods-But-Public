...
module.exports = {
    name: "outro",
    description: "outroduces message author",
    async execute(client, message, args) {
        ...
        if (message.member.roles.cache.some(h => perms.includes(h.id))) {
            ...
            const outro = new Discord.MessageEmbed()
                .setAuthor(`I hope i have somehow helped you. Bye!`)
                .setColor(client.config.main_config.color)
            message.channel.send(outro)
